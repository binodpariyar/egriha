...
if(isset($edit)) {
	$path = admin_url().'client_management/update_project/'.$edit->id;
	...
	$path = admin_url().'client_management/process_project/'.$id;
}
...
<form enctype="multipart/form-data" class="horizontal-form" method="post" action="<?php echo $path; ?>">
	...
	<div class="col-md-5 pull-right">
		...
		<div class="form-group">
			...
			<img width="100px;" src="<?php echo base_url().'uploads/milestone_images/'.$edit->image_3; ?>" class="img-thumbnail" />
			<?php } else{ ?>
