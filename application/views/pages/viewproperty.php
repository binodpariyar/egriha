<div id="main_secondary">
  <h2><?php echo get_property_type($details->type); ?> <?php echo get_for_type($details->for); ?> for <?php echo $details->price; ?> at <?php echo $details->location; ?> </a> ( <strong><?php echo ($details->status == 1) ? 'Approved' : 'Pendding Approval' ; ?> </strong>)</h2>
